...
COMPONENT_FILES	:= Compare.sv generate_guess.sv Calculate_NTLM_reg.sv tx_data.sv flex_counter.sv flex_pts_sr.sv flex_stp_sr.sv start_bit_det.sv stop_bit_chk.sv rx_data_buff.sv timer.sv sr_9bit.sv rcu.sv rcv_block.sv edge_detector.sv giant_hash_sr.sv Clock_Divider.sv controller.sv 

# Specify the name of the top level file (do not include the source folder in the name)
# NOTE: YOU WILL NEED TO SET THIS VARIABLE'S VALUE WHEN WORKING WITH HEIRARCHICAL DESIGNS
# AND THE AUTOMATED GRADING SYSTEM
TOP_LEVEL_FILE	:= hashcracker.sv  #on_chip_sram_wrapper.vhd
